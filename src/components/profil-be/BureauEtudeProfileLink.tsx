...
export function BureauEtudeProfileLink({
  ...
  return (
    <a
      ...
      aria-label={`Consulter la fiche de ${nom} (nouvel onglet)`}
      className={cn(
    ...
    >
      ...
      <ExternalLink
        aria-hidden="true"
        className="h-3.5 w-3.5 text-slate-400 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-blue-600"
      />
    </a>
  );
}
